...
if __name__ == "__main__":
    ...
    for row in range(512):
        ...
        for i in range(9):
            ...
            hdown2 = hmapping[1::2, 1::2]
            gdown2 = gmapping[1::2, 1::2]
...
#        plt.show()
    ...
    for col in range(512):
        img_col = filtered_img[:,col]
        sz = np.size(img_row)

        col_diag = sparse.spdiags(img_col, 0, sz, sz).tocsr()
        ...
        # Column Wavelet Transform and filter
